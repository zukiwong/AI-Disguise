...
function addBasicReportFooter(pdf) {
  ...
  for (let i = 1; i <= pageCount; i++) {
    ...
    // 品牌信息
    pdf.text('Generated by AI Disguise - Smart Text Expression Assistant', 105, 285, { align: 'center' })
  }
}
...
<head>
    ...
    <title>AI Disguise Favorite Collection</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>Generated by <strong>AI Disguise</strong> - Smart Text Expression Assistant</p>
            <p>Thank you for using AI Disguise, continue creating amazing expressions!</p>
        </div>
    </div>
</body>
</html>
