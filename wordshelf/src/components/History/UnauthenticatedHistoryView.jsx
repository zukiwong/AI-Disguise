    ...
    <div className="unauthenticated-history-wow">
      ...
      <div className="wow-header">
        <h2 className="main-title">
          <span className="title-desktop">Oops, this page needs you to log in.</span>
          <div className="title-mobile">
            <div className="title-line-1">Oops,</div>
            <div className="title-line-2">this page needs you to log in.</div>
          </div>
        </h2>
        <p className="subtitle">But check out these amazing disguise styles</p>
      </div>
...
export default UnauthenticatedHistoryView